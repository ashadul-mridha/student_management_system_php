...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><i class="fa fa-dashboard text-primary"></i><a href="index.php">Dashboard</a></li>
    ...
    <div class="col-sm-6">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" placeholder="Student Name" class="form-control" require>
            </div>
            <div class="form-group">
                <label for="roll">Roll</label>
                <input type="text" name="roll" id="roll" placeholder="Student Roll" class="form-control" require> 
            </div>
            <div class="form-group">
                <label for="city">City</label>
                <input type="text" name="city" id="city" placeholder="Student Address" class="form-control" require>
            </div>
            <div class="form-group">
                <label for="pcontact">Parents Phone Number</label>
                <input type="text" name="pcontact" id="pcontact" placeholder="01*********" class="form-control" require>
            </div>
            <div class="form-group">
                <label for="class">Class</label>
                <select name="class" id="class" class="form-control" require>
